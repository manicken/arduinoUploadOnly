 ...
 */
public class MyEditorToolbar extends JComponent implements MouseInputListener, KeyEventDispatcher {

  /**
   * Rollover titles for each button.
   */
  private static final String[] title = {
    tr("Verify"), tr("Upload Only"), tr("New"), tr("Open"), tr("Save"), tr("Serial Monitor")
  };
  ...
  private static final String[] titleShift = {
    tr("Verify"), tr("Upload Only Using Programmer"), tr("New"), tr("Open"), tr("Save As..."), tr("Serial Monitor")
  };
  ...
  java.util.function.Consumer<Boolean> customUploadAction;

  public MyEditorToolbar(Editor editor, JMenu menu, java.util.function.Consumer<Boolean> customUploadAction) {
    this.editor = editor;
    this.menu = menu;
    ...
    switch (sel) {
      case RUN:
        if (!editor.avoidMultipleOperations) {
          java.lang.Runnable presentHandler = (java.lang.Runnable)Reflect2.GetField("presentHandler", editor);
          java.lang.Runnable runHandler = (java.lang.Runnable)Reflect2.GetField("runHandler", editor);
...
//    
      case OPEN:
        ...
        popup.show(MyEditorToolbar.this, x, y);
        break;
      ...
      case EXPORT:
        ...
        if (!editor.avoidMultipleOperations) {
          ...
          customUploadAction.accept(isShiftDown);
